                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="fee" class="form-control" id="fee" rows="1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="timing" class="form-control" id="timing" rows="1"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="fee" class="form-control" id="update_fee" rows="1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="timing" class="form-control" id="update_timing" rows="1"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            $('#insert_event').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        $('#modalBox').modal('hide');
                        toastr.success('Insert event data successful');
                        load();
                    }
                });
                return false;
            ...
            edit_data=function(id){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#update_fee').val(event['fee']);
                        $('#update_date').val(event['date']);
                        $('#update_timing').val(event['timing']);
                        $('#update_location').val(event['location']);
                        $('#update_category').val(event['event_category']);
                        ...
                        $('#update_detail').summernote('code',event['detail']);
            ...
            $('#update_data').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        toastr.success('Update event data successful');
                        load();
                    }
                });
                return false;
